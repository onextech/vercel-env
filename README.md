...
@onextech/vercel-env/2.0.0 darwin-x64 node-v10.22.1
...
_See code: [src/commands/development.ts](https://github.com/kykungz/vercel-env/blob/v2.0.0/src/commands/development.ts)_
...
_See code: [src/commands/preview.ts](https://github.com/kykungz/vercel-env/blob/v2.0.0/src/commands/preview.ts)_
...
_See code: [src/commands/production.ts](https://github.com/kykungz/vercel-env/blob/v2.0.0/src/commands/production.ts)_
<!-- commandsstop -->
